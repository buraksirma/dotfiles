...
local lsp_get = vim.diagnostic.get

local lsp_get_diag = function(type)
  local count = #lsp_get(0, { severity = type})
...
local comps = {
    ...
    diagnos = {
        err = {
            ...
            provider = function()
                return '' .. lsp_get_diag(lsp_severity.ERROR)
            end,
            -- left_sep = ' ',
        ...
        warn = {
            ...
            provider = function()
                return '' ..  lsp_get_diag(lsp_severity.WARN)
            end,
            -- left_sep = ' ',
        ...
        info = {
            ...
            provider = function()
                return '' .. lsp_get_diag(lsp_severity.INFO)
            end,
            -- left_sep = ' ',
        ...
        hint = {
            ...
            provider = function()
                return '' .. lsp_get_diag(lsp_severity.HINT)
            end,
            -- left_sep = ' ',
